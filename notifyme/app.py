...
import notifyme.commands as commands
from notifyme.config import DevelopmentConfig
from notifyme.constants import HTTP_CODES
from notifyme.errorhandlers import handle_api_error, handle_http_error
from notifyme.exceptions import ApiError
from notifyme.prefix_middleware import PrefixMiddleware
...
def register_blueprints(app):
    ...
    from notifyme.blueprints.health_check import health_check_blueprint
    app.register_blueprint(health_check_blueprint)
    from notifyme.blueprints.aws import aws_blueprint
